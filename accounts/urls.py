...
from . import views
from .views import (
    signup_view, select_role_view, recommend_doctor_view, login_view,
    faq_page, add_question, add_answer, upvote_question, upvote_answer,
    profile_view, upload_profile_picture, remove_profile_picture, your_questions,
    delete_question, delete_answer, submit_feedback, edit_profile
)
